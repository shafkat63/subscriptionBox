...
<body>
  ...
  <div class="weekheader">
    ...
    <h3>Fill out our personalization monthly survey so that we can know your preferences each and every month! We'll curate your snack box based on what you prefer!</h3>
  ...
  <?php
  $query = "SELECT * FROM product where catagory='monthly box' ORDER BY p_id ASC limit 0,12";
  ...
  ?>
      ...
      <section class="section all-products" id="products">
        ...
        <div class="week2product">
          ...
          <div class="col-md-4">
            <form method="post" action="page1.php?token=<?php echo $_GET["token"]; ?>& action= add&p_id=<?php echo $row["p_id"]; ?>">
